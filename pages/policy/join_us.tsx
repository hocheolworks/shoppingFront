...
const JoinUs: FC = () => {
  ...
  const fregister_submit = (event: FormEvent<HTMLFormElement>): void => {
    ...
    if(!check2) {
      if(error_text.length >3){
        error_text += "과 "
      }
      error_text += "개인정보처리방침안내"
    }
        ...
        <div id="container_wr">
          ...
          <div id="register_agree">
            ...
            <form name="fregister" id="fregister" autoComplete="off" onSubmit={fregister_submit}>
              <div id="fregister_chkall" className="checks2">
                <input type='checkbox' name="chk_all" value='1' id='chk_all' onClick={allCheck} checked={allChk}/>
              ...
              <section id="fregister_private">
                <fieldset className="fregister_agree2 checks2">            
                  <input type="checkbox" name="agree2" value="1" id="agree21" checked={check2} onChange={handleCheck2}/>
                    <label htmlFor="agree21">개인정보 수집 및 이용 동의<span>(필수)</span></label>
                </fieldset>
                <textarea readOnly id="area2">
                  {text2}
                </textarea>
              </section>

              <div className="btn_confirm">
                <Link href={'/'}><a className='btn_cancel'>취소</a></Link>
