...
const Privacy: FC = () => {
  return (
    <div className="container container-table" id="mid">
      <div className="col ">
        <h4 className="text-center mb-5 mt-5">개인정보 처리방침</h4>
        <div></div>
        <p>
          <strong>
            제1조(개인정보의 처리 목적)
            <br />
            <br />
            <em>{`<진솔유통>`}('https://jinsoltrade.com/'이하 '진솔유통')</em>
          ...
          <ul className="list_indent2 mgt10">
            ...
            <p className="ls2">
              물품배송, 서비스 제공, 계약서·청구서 발송, 요금결제·정산을
              목적으로 개인정보를 처리합니다.
            </p>
            <br></br>
          </ul>
          ...
          <p className="lh6 bs4">
            ...
            <br></br>
            <br></br>①<em className="emphasis">{`<진솔유통>`}</em>
            은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
            개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서
            개인정보를 처리·보유합니다.<br></br>
          ...
          <ul className="list_indent2 mgt10">
            ...
            <li>
              ...
              <br></br>2) 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년<br></br>
          ...
          <ul className="list_indent2 mgt10">
            <li className="tt">{`1<홈페이지 회원가입 및 관리>`}</li>
            <li>
              필수항목 : 이메일, 휴대전화번호, 자택주소, 자택전화번호, 비밀번호
              질문과 답, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 회사전화번호,
              신용카드정보, 은행계좌정보, 서비스 이용 기록, 접속 로그, 쿠키,
              접속 IP 정보, 결제기록
            </li>
            <li>선택항목 : </li>
          </ul>
          ...
          <p className="ls2">
            <br></br>① {`<진솔유통>`}은(는) 개인정보 보유기간의 경과, 처리목적
            ...
            옮기거나 보관장소를 달리하여 보존합니다.<br></br>1. 법령 근거 :
            <br></br>2. 보존하는 개인정보 항목 : 계좌정보, 거래날짜<br></br>
            <br></br>③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.<br></br>
            1. 파기절차<br></br>
            {`<진솔유통>`}
            은(는) 파기 사유가 발생한 개인정보를 선정하고, {`<진솔유통>`}의
        ...
        <p className="ls2">
          <br />
          <br />① 정보주체는 진솔유통에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p className="sub_p">
          ② 제1항에 따른 권리 행사는진솔유통에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 진솔유통은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p className="sub_p">
        ...
        <p className="sub_p">
          ⑥ 진솔유통은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <p className="sub_p mgt10">
          1. 정기적인 자체 감사 실시
          <br></br>개인정보 취급 관련 안정성 확보를 위해 정기적(분기 1회)으로
          자체 감사를 실시하고 있습니다.<br></br>
          <br></br>2. 개인정보 취급 직원의 최소화 및 교육<br></br>개인정보를
          취급하는 직원을 지정하고 담당자에 한정시켜 최소화 하여 개인정보를
          관리하는 대책을 시행하고 있습니다.<br></br>
          <br></br>3. 내부관리계획의 수립 및 시행<br></br>개인정보의 안전한
          처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다.<br></br>
          <br></br>4. 개인정보에 대한 접근 제한<br></br>개인정보를 처리하는
          데이터베이스시스템에 대한 접근권한의 부여,변경,말소를 통하여
          개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며
          침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있습니다.
          <br></br>
          <br></br>5. 비인가자에 대한 출입 통제<br></br>개인정보를 보관하고 있는
        ...
        <p className="lh6 bs4">
          ...
          개인정보를 추가적으로 이용·제공할 수 있습니다.<br></br>
          이에 따라 {`<진솔유통>`}가(이) 정보주체의 동의 없이 추가적인
          이용·제공을 하기 위해서 다음과 같은 사항을 고려하였습니다.
          <br></br>▶ 개인정보를 추가적으로 이용·제공하려는 목적이 당초 수집
          목적과 관련성이 있는지 여부
        </p>
        <p className="sub_p"></p>
        <p className="sub_p"></p>
        ...
        <p className="lh6 bs4">
          ...
          <br></br>
          <br></br>
          {`<진솔유통>`}은(는) 다음과 같은 목적으로 가명정보를 처리하고
          있습니다.
        </p>
        <p className="sub_p"></p>
        ...
        <ul className="list_indent2 mgt10">
          ...
          <li>직책 :대표</li>
          <li>직급 :대표</li>
          <li>연락처 :010 4826 0519, jinsoltrade@gmail.com, </li>
        </ul>
        <p className="sub_p">
          ※ 개인정보 보호 담당부서로 연결됩니다.
          <p />
          ...
          <p className="sub_p">
            ② 정보주체께서는 진솔유통 의 서비스(또는 사업)을 이용하시면서 발생한
            모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
            개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 진솔유통
          ...
          <p className="lh6 bs4">
            ...
            <br></br>
            <br></br>정보주체는 ｢개인정보 보호법｣ 제39조의11에 따라 지정된
            {`<진솔유통>`}의 국내대리인에게 개인정보 관련 고충처리 등의 업무를
            위하여 연락을 취할 수 있습니다.
            {`<진솔유통>`}
            은(는) 정보주체의 개인정보 관련 고충처리 등 개인정보 보호책임자의
            업무 등을 신속하게 처리할 수 있도록 노력하겠습니다. <br />
            <br />
            <p>
              ▶ {`<진솔유통>`}은(는) ｢개인정보 보호법｣ 제39조의11에 따라
              국내대리인을 지정하였습니다.
            </p>
            <p className="sub_p"></p>
            <p className="sub_p"></p>
            ...
            <p className="sub_p mgt30">
              <strong>
                ...
                <br></br>정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의
            ...
            <p className="sub_p mgt30">
              1.영상정보처리기기 설치근거·목적 :
              <span className="colorLightBlue">{`<진솔유통>`}</span>의
            </p>
            <ul className="list_indent2 mgt10">
