...
import { forgotPassword, formReset } from '../src/redux/thunks/auth-thunks';
import { validateEmail } from '../src/utils/input-validators';
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-4">
            <input
              ...
              value={email}
              className={
                validateEmailError ? 'form-control is-invalid' : 'form-control'
              }
